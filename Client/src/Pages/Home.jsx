...
import { FaUtensils, FaRobot, FaPaperPlane, FaClock, FaUserFriends, FaLightbulb } from 'react-icons/fa'
...
const palette = {
    ...
    icon: 'text-[#ff7043]',
    sectionTitle: 'text-[#ff7043] font-semibold text-lg mb-2 flex items-center gap-2',
        ...
        <div className={`min-h-screen flex flex-col ${palette.bg}`}>
            ...
            <header className="flex flex-col items-center py-8">
                <img
                    ...
                    className="w-20 h-20 rounded-full shadow-lg border-4 border-white mb-3 object-contain bg-white"
                />
                <h1 className={`text-4xl font-extrabold ${palette.header} drop-shadow flex items-center gap-2`}>
                ...
                <p className="text-lg text-[#6d4c41] font-medium text-center max-w-xl mt-2">
                    Ask anything about recipes, ingredients, or cooking tips. Let our AI chef inspire your next meal!
                </p>
            </header>
                    ...
                    {recipe && (
                        <div className={palette.card}>
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                <span className={palette.chip}><FaClock className="inline mr-1" /> {recipe.cookingTime}</span>
                                <span className={palette.chip}><FaUserFriends className="inline mr-1" /> {recipe.servings} servings</span>
                            </div>
                            <div className={palette.divider}></div>
                            {/* Ingredients */}
                            <div className="mb-4">
                                <div className={palette.sectionTitle}><FaUtensils /> Ingredients</div>
                            ...
                            {/* Instructions */}
                            <div className="mb-4">
                                <div className={palette.sectionTitle}><FaRobot /> Instructions</div>
                            ...
                            {recipe.tips && recipe.tips.length > 0 && (
                                <div className="mb-2">
                                    <div className={palette.sectionTitle}><FaLightbulb /> Tips</div>
            ...
            <footer className="mt-8 mb-4 text-center">
                <p className="text-sm text-[#a1887f]">© {new Date().getFullYear()} Byte-2-Bite. All rights reserved.</p>
            </footer>
        </div>
    )
}
